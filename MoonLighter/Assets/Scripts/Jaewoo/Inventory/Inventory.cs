...
public class Inventory : MonoBehaviour
{
    ...
    public int mSeletX = 0;
    public int mSeletY = 0;
    ...
    void Update()
    {
        ...
        {
            mSeletX++;
            mSelectPoint.transform.localPosition = mInventoryArray[0,mSeletX].transform.localPosition;
            Debug.Log(mSelectPoint.transform.position);


            // mSelectPoint[mSeletY, mSeletX + moveX].SetActive(true);
            // mSelectPoint[mSeletY, mSeletX].SetActive(false);
        }if (Input.GetKeyDown(KeyCode.A))
        {
            Debug.Log(mInventoryArray[0,0]);
            Debug.Log(mInventoryArray[0,1]);
            Debug.Log(mInventoryArray[0,2]);
